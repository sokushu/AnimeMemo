...
public class GetClassTest {
	 ...
	 * @param obj2
	 */
	private GetClassTest(Class<? extends Object> class1, Object obj2) {
		this.CVlass = class1;
		obj = obj2;
	}
	 ...
	 * @return
	 */
	public static GetClassTest loadClass(Object obj) {
		return new GetClassTest(obj.getClass(), obj);
	}

	@SuppressWarnings("unchecked")
	public static <T> T To(Object obj, Type<T> type) {
		return (T)obj;
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T> T getField(String fieldName, Type<T> type) throws Exception {
	 ...
	 * @param value
	 */
	public <T> void setField(String fieldName, Type<T> value) {
		try {
