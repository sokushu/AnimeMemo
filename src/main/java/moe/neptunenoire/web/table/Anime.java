 ...
 */
@Entity
@Table(name="anime", indexes={@Index(name="key_ofmy", columnList="anime_id,anime_class")})
public class Anime {
	/**
	 * 动画ID
	 */
...
//==================================================
	...
	public Integer getAnime_class() {
		return anime_class;
	}
	public void setAnime_class(Integer anime_class) {
	...
	public Anime(Integer anime_id, String anime_name, Integer anime_number, Integer anime_class, String anime_pic,
			...
			String anime_info_ed, String anime_info_edsonger, Date date, Date date_new) {
		super();
		this.anime_id = anime_id;
		this.anime_name = anime_name;
		this.anime_number = anime_number;
